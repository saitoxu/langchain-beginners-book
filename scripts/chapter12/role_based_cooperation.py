...
from scripts.chapter12.single_path_plan_generator import (
    DecomposedTasks,
    QueryDecomposer,
)
...
if __name__ == "__main__":
    ...
    result = agent.run(query="風呂に換気扇がない")
    print(result)
